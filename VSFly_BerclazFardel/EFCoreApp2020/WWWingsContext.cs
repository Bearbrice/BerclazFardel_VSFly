...
namespace EFCoreApp2020
{
    public class WWWingsContext : DbContext
    {
        ...
        public static string ConnectionString { get; set; } = @"Server=(localDB)\MSSQLLocalDB;Database=WWWings_2020Corr1;Trusted_Connection=True;MultipleActiveResultSets=True;App=EFCoreApp2020";
